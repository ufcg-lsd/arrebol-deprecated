package org.fogbowcloud.cli.restlet;
...
public class TestJDFSchedulerAppClientSide {
	...
	public JDFSchedulerApplicationWithPersistence jdfApp;
	Scheduler scheduler;
	...
	public void setup() throws Exception {
		...
		jdfApp = spy(new JDFSchedulerApplicationWithPersistence(scheduler, properties, db));
	...
	public void testGetNonExistingTaskContent() throws ClientProtocolException, IOException {
		...
		doReturn(fakeJob).when(jobMap).put(FAKE_JOB_ID, fakeJob);

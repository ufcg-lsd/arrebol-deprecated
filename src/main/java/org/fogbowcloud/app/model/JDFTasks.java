...
public class JDFTasks {
    ...
    public static void addRemoteCommand(String jobId, Task task, RemoteCommand remCommand, String schedPath) {
    	 Command command = new Command("\"" + remCommand.getContent() + " ; echo $? > " + task.getMetadata(TaskImpl.METADATA_REMOTE_COMMAND_EXIT_PATH) + "\"" +task.getNumberOfCommands(), Command.Type.REMOTE);
